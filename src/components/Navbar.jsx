...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      ...
      >
        <li>
          <a href="#myHero" className="sm:text-lg text-base font-medium">
            Beranda
          </a>
        </li>
        <li>
          <a href="#myProyek" className="sm:text-lg text-base font-medium">
            Proyek
          </a>
        </li>
        <li>
          <a href="#myKontak" className="sm:text-lg text-base font-medium">
            Kontak
          </a>
        </li>
      </ul>
